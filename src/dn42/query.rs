...
pub enum DN42QueryType {
    IPv4Network { ip: Ipv4Addr, mask: u8 },
    IPv6Network { ip: Ipv6Addr, mask: u8 },
    ASN { asn: String },
    Person { handle: String },
    Maintainer { handle: String },
    Schema { handle: String },
    Organisation { handle: String },
    TincKeyset { handle: String },
    TincKey { handle: String },
    RouteSet { handle: String },
...
pub fn format_ipv4_network_response(query: &str, inetnum_content: Option<String>, route_content: Option<String>) -> String {
    let mut response = String::new();
    response.push_str(&format!("% Query: {}\n", query));
...
pub fn format_ipv6_network_response(query: &str, inet6num_content: Option<String>, route6_content: Option<String>) -> String {
    let mut response = String::new();
    response.push_str(&format!("% Query: {}\n", query));
